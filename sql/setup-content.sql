...
INSERT INTO `content` (`path`, `slug`, `type`, `title`, `data`, `filter`, `created`, `published`) VALUES
	("Sidebar-right", null, "block", "Links",
"
* [Have a problem?](https://www.google.se)
* [Want to waste time?](https://www.youtube.com)
* [Reddit](https://www.reddit.com)", "markdown", NOW(), NOW());
